...
public class Pzpay {
    ...
    public Pzpay(String partner_id, Long bank_id, String payCode, String notify_url, String return_url, String out_trade_no, BigDecimal total_fee, String bank_code) {
        this.partner_id = partner_id;
        this.bank_id = bank_id;
        this.pay_type =payCode;
        this.return_url=return_url;
        this.notify_url=notify_url;
        this.out_trade_no=out_trade_no;
        this.total_fee=Integer.valueOf(total_fee.multiply(new BigDecimal(100)).toString());
